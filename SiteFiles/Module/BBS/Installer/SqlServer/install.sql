 ...
 * Author :       ThinkPad
 *
 * Date Created : Thursday, March 22, 2012 14:41:57
...
CREATE TABLE bbs_Face(
    ...
    Taxis        int             DEFAULT 0 NOT NULL,
    IsEnabled    varchar(18)     DEFAULT '' NOT NULL,
    CONSTRAINT PK_bbs_Face PRIMARY KEY NONCLUSTERED (FaceName)
)
go
...
CREATE TABLE bbs_UserGroup(
    ...
    ExtendValues    ntext           DEFAULT '' NOT NULL,
    CONSTRAINT PK_bbs_UserGroup PRIMARY KEY NONCLUSTERED (GroupID)
)
go
...
CREATE TABLE bbs_Users(
    ...
    SettingsXML        ntext            DEFAULT '' NOT NULL,
    CONSTRAINT PK_bbs_Users PRIMARY KEY NONCLUSTERED (UserName)
)
go
