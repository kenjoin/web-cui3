...
<body>
<form onsubmit="onSubmit(this);return false;" action="?isPostBack=True&forumID=<%=Request.QueryString["forumID"]%>&threadID=<%=Request.QueryString["threadID"]%>&threadIDArray=<%=Request.QueryString["threadIDArray"]%>&postIDArray=<%=Request.QueryString["postIDArray"]%>" method="post">
  <div class="container">
