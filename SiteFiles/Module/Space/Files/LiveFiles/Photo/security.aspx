<%@ Page SmartNavigation="False" Language="C#" Inherits="SiteServer.Space.Photo.Pages.PhotoSecurity" %>
          ...
          <TBODY>
            <TR>
              ...
              <TD valign="top" style="width:220px;"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><H3 style="MARGIN-TOP: 0px"><nobr>谁可以查看这张图片?</nobr></H3></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td><H3><nobr>是否允许评论这张图片?</nobr></H3></td>
                  </tr>
                  <tr>
                    <td><asp:CheckBox ID="IsCommentable" Checked="true" Text="允许评论" runat="server"></asp:CheckBox></td>
                  </tr>
                </table></TD>
              <TD valign="top"><div><h4><%=GetTitle()%></h4></div><div style="MARGIN-TOP: 0px"><%=GetImageHtml()%></div></TD>
            </TR>
          </TBODY>
        </TABLE></td>
      <td width='8'><img  width=8 height=1></td>
