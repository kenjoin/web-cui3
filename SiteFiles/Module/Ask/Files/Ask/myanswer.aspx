<%@ Page Language="C#" Inherits="SiteServer.Ask.Pages.MyAnswer" %>
                ...
                <tr valign="top">
                    ...
                    <td width="831" class="bor_cc left0px f14px">
                        <div class="box_con" style="padding: 15px;">
                            <table width="720" border="0" cellspacing="0" cellpadding="0" class="grey ln26">
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <img src="../ask/images/icon_ok.gif" width="17" height="9" />
                                        回答被采纳
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <p class="c8b ln26">
                                回答可获得<asp:Literal ID="ltlCreditAnswer" runat="server"></asp:Literal>积分。<br />
                                回答被采纳除了获得悬赏分外，还可以奖励<asp:Literal ID="ltlCreditAnswerAccept" runat="server"></asp:Literal>积分。</p>
                            <p class="hack15px">
                            </p>
                            <div class="tab1" style="width: 800px;" id="answerType" runat="server">
                            </div>
                            <div class="list_com">
                                <p class="hack10px"> 
                                </p>
                                <dl class="ln29" style="width: 790px;">
                                    <dt class="grey"><span class="sp9">标题</span><span class="sp2">回答数</span><span class="sp3">状态</span><span
                                        class="sp4">被采纳回答</span><span class="sp8">提问时间</span></dt>
                                    <asp:DataList ID="dlAnswerList" runat="server">
                                        <ItemTemplate>
