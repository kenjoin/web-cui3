<%@ Control Language="c#" Inherits="SiteServer.Ask.Controls.Footer" %>

<div class="main">
  <div class="hack10px"></div>
  <div class="box950">
    <div class="friends">
      <div class="frtit">友情链接</div>
      <div id="frdiv">
        <asp:Literal ID="ltlLinkItem" runat="server"></asp:Literal>
      </div>
    </div>
    <div class="hack10px"></div>
  </div>
...
<DIV id="bottom">
  <DIV class="sites">
    <div>
      <div>
        <div id="copyright">
          <asp:Literal ID="ltlFootString" runat="server"></asp:Literal>
        </div>
        <div id="poweredby">
...
<asp:Literal ID="ltlAdScripts" runat="server"></asp:Literal>
