  ...
  <tr>
    ...
    <td>
      <table border="0" align="center" cellpadding="0" cellspacing="0" class="digg">
        ...
        <tr>
          <td class="diggit">
            <a href="javascript:undefined;" onclick="<%=ClickStringOfGood%>"><asp:Literal ID="ltlGoodText" runat="server"></asp:Literal></a>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td>
      <table border="0" align="center" cellpadding="0" cellspacing="0" class="digg">
        ...
        <tr>
          <td class="diggit">
            <a href="javascript:undefined;" onclick="<%=ClickStringOfBad%>"><asp:Literal ID="ltlBadText" runat="server"></asp:Literal></a>
          </td>
        </tr>
      </table>
    </td>
