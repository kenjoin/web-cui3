<%@ Page language="c#" trace="false" enableViewState="false" Inherits="SiteServer.CMS.Pages.InnerLogin" %>
    ...
    <asp:PlaceHolder ID="phLoggedInTemplate" runat="server">
      <TR>
        <TD colspan="2" style="line-height:22px;">
            ...
            <A href="<%=UserCenterUrl%>" target="usercenter">用户中心</A>&nbsp;&nbsp;<A href="javascript:undefined;" onclick="<%=LogoutClickString%>">退 出</A>
        </TD>
      </TR>
    </asp:PlaceHolder>
    </TBODY>
