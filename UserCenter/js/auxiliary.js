...
function SelectAttachment(attributeName, attachmentUrl, fileViewUrl)
{
	...
	_get("del_" + attributeName).innerHTML = "<a href='javascript:undefined;' onclick=\"" + fileViewUrl + "\">查看</a> <a href='javascript:undefined;' onclick=\"DeleteAttachment('" + attributeName + "');\">移除</a>";
