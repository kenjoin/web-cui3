<%@ Page Language="C#" Inherits="UserCenter.System.CMS.ContentPhotoUpload" %>
...
<bairong:Code ID="Code2" type="fancybox" runat="server" />
...
<style type="text/css">
.upload{
	background-image:url(../../sitefiles/bairong/scripts/swfUpload/button.png); width:114px; height:22px; text-align:left; padding:3.5px 16px; cursor:default;
}
</style>
</head>
...
<form id="myForm" style="margin:0" runat="server">
  ...
  <div class="path">
  <p>当前位置：内容管理<span>&gt;</span>添加投稿<span>&gt;</span>上传图片</p>
</div>
  <div class="main-cont">
