<%@ Page Language="C#" Inherits="UserCenter.System.Space.CommentBlog" %>
...
function delInfo() { 
	...
	var url = 'commentBlog.aspx?Delete=True&CommentIDCollection=' + v;
...
<form runat="server">
  ...
  <div class="main-cont">
    <div class="tab-box">
      <h5 class="tab-nav tab-nav-s1 clear"> <a class="current" href="commentBlog.aspx"><span>博客评论</span></a> <a href="commentPhoto.aspx"><span>相册评论</span></a> </h5>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
              ...
              <tbody id="recordList">
                  ...
                  <asp:Repeater ID="dlContents"  runat="server">
                    <itemtemplate>
                      <tr>
                        ...
                        <td><asp:Literal ID="ltlBlog" runat="server"></asp:Literal></td>
                ...
                <asp:PlaceHolder ID="phNoData" runat="server">
                  <tr>
                    <td colspan="5"><p class="no-data">暂无日志评论</p></td>
                  </tr>
                </asp:PlaceHolder>
              </tbody>
