...
<head runat="server">
    ...
    <link href="/BBS/js/jquery.select/selectStyle.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/BBS/js/jquery.select/jquery.select-1.3.6.js"></script>
    ...
    <%if (base.isPoll)
      {%><link href="/BBS/css/vote.css" rel="stylesheet" type="text/css" /><script language="javascript"
          type="text/javascript" src="/BBS/js/DatePicker/WdatePicker.js"></script><script language="javascript"
...
<script type="text/javascript" language="javascript">    document.ondblclick = function (x) { location.href = 'http://localhost:99/siteserver/bbs/background_utils.aspx?type=CreatePage&directoryName=&fileName=post.aspx&forumID=0'; }</script>
