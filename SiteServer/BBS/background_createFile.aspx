...
<div class="tab">
  ...
  <DIV class="column">
    ...
    <table width="95%" align="center" cellpadding="3" cellspacing="3">
      <tr>
        <td width="160" align="left"><bairong:help HelpText="请选择要生成的文件页（可多选）" Text="生成文件页：" runat="server" ></bairong:help>
        </td>
      ...
      <tr>
        <td width="160" align="left"><bairong:help HelpText="把所有文件页重新生成" Text="生成全部文件页：" runat="server" ></bairong:help>
        </td>
        <td align="left"><asp:Button class="button" style="margin-bottom:0px;" id="CreateFileButton" text="生成选定文件" onclick="CreateFileButton_OnClick" runat="server" />
        </td>
      </tr>
    </table>
  </div>
