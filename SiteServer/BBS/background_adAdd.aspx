...
<form id="myForm" runat="server">
  ...
  <tr>
   <%-- <td valign="top"><a id="imageUrlLink1" style="" href="javascript:;" onClick="$('imageUrlLink2').style.fontWeight = '';this.style.fontWeight = 'bold';$('ImageUrlUploader').style.display = '';$('ImageUrl').style.display = 'none'">上传图片</a>&nbsp;
                                    <a id="imageUrlLink2" style="font-weight:bold" href="javascript:;" onClick="$('imageUrlLink1').style.fontWeight = '';this.style.fontWeight = 'bold';$('ImageUrlUploader').style.display = 'none';$('ImageUrl').style.display = ''">输入 URL</a></td>--%>
<td valign="top"><a id="imageUrlLink1" style="" href="javascript:;" onClick="document.getElementById('imageUrlLink2').style.fontWeight = '';this.style.fontWeight = 'bold';document.getElementById('ImageUrlUploader').style.display = '';document.getElementById('ImageUrl').style.display = 'none'">上传图片</a>&nbsp;
  ...
  <tr>
    <td valign="top"><a id="flashUrlLink1" style="" href="javascript:;" onClick="$('flashUrlLink2').style.fontWeight = '';this.style.fontWeight = 'bold';$('FlashUrlUploader').style.display = '';$('FlashUrl').style.display = 'none'">上传Flash</a>&nbsp;
