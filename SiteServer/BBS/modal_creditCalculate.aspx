...
<form id="myForm" runat="server">
  ...
  <table cellpadding="2" cellspacing="2" width="95%" align="center">
    <tr>
      <td align="left">发帖数(PostCount)：</td>
      <td align="left">× <asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Width="60" id="txtPostCount" runat="server"/>
    ...
    <tr>
      <td align="left">精华帖数(PostDigestCount)：</td>
      <td align="left">× <asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Width="60" id="txtPostDigestCount" runat="server"/>
        <asp:RequiredFieldValidator
