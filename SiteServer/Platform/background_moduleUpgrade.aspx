<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.BackgroundModuleUpgrade" %>
...
<form id="myForm" runat="server">
  <div id="success" style="position:absolute;z-index:300;height:120px;width:320px;left:50%;top:160px;margin-left:-150px;margin-top:-80px; display:none">
    <div class="column" style="position:absolute;z-index:300;width:100%;left:4px;top:5px;height:90px;font-size:14px;background-color:#FFFFFF">
      ...
      <div class="content" style="height:64px;line-height:150%;" align="center"><BR />
        <img border="0" src="../pic/animated_loading.gif" align="absmiddle" />&nbsp;正在运行升级程序, 请稍候... <BR />
        <BR />
      </div>
    </div>
  </div>
  ...
  <DIV class="column">
    <div class="columntitle"> 升级平台产品</div>
    <table width="95%" align="center" cellpadding="5" cellspacing="5">
      ...
      <tr>
        <td width="187" align="left"><bairong:help HelpText="当前版本号" Text="当前版本号：" runat="server" ></bairong:help></td>
        <td align="left"><asp:Literal ID="VersionCurrent" runat="server"></asp:Literal></td>
      </tr>
      <tr>
        <td width="187" align="left"><bairong:help HelpText="升级到版本号" Text="升级到版本号：" runat="server" ></bairong:help></td>
        <td align="left"><asp:Literal ID="VersionUpgrade" runat="server"></asp:Literal></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="left" colspan="2"><div class="tips"><strong>注意事项：</strong> 升级需要复制的文件在 SiteFiles/<%=Request.QueryString["ModuleDir"]%>/Files 中，升级时请确保文件列表中涉及的目录有可写入权限。 </div></td>
      </tr>
      <tr>
        <td colspan="2" align="center"><asp:Button class="button" id="Submit" text="开始升级" onclick="Submit_OnClick" runat="server" />
          &nbsp;&nbsp;
