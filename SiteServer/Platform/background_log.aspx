<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.BackgroundLog" %>
...
<form id="myForm" style="margin:0" runat="server">
    ...
    <TABLE width="100%" border=0 align=center cellPadding=2 cellSpacing=2>
      <TBODY>
        <TR class=summary-title align=left>
          <TD align=left style="padding-left:10px; line-height:28px;"> 时间：从
  ...
  <DIV id="contents" class="column">
    <div class="columntitle">管理员日志</div>
    <asp:DataList ID="MyDataList" ShowHeader="true" cellspacing="1" cellpadding="1" Align="center" border="0" Width="100%" runat="server" style="word-break: break-all">
      <headertemplate>
        <tr class="summary-title" style="height:25px;">
          <td align="Center" style="width:100px;" width="100">&nbsp;管理员</td>
          <td align="Center" style="width:150px;" width="100">IP地址</td>
      ...
      <itemtemplate>
        <tr class="tdbg" onMouseOver="this.className='tdbg-dark';" onMouseOut="this.className='tdbg';" style="height:25px;">
          <td align="Center" style="width:100px;" width="100"><asp:Literal ID="ltlUserName" runat="server"></asp:Literal></td>
          <td align="Center" style="width:150px;"><asp:Literal ID="ltlIPAddress" runat="server"></asp:Literal></td>
  ...
  <table width="95%" align="center">
    <tr>
      <td align="right"><table cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td align="left"><asp:Button class="button" id="Delete" Text="删除" runat="server" />
              &nbsp;
              <asp:Button class="button" id="DeleteAll" Text="删除全部" runat="server" /></td>
