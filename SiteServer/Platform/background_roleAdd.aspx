<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.BackgroundRoleAdd" %>
  ...
  <table width="95%" align="center" cellspacing="0" cellpadding="0" >
    <tr>
      ...
      <td align="center" ><asp:Button class="button" id="Submit" text="添 加" onclick="Submit_OnClick" runat="server"/>
        ...
        &nbsp;&nbsp;
        <input type="button" class="button" value="返 回" onClick="javascript:location.href='background_role.aspx?ModuleID=<%= Request.QueryString["ModuleID"]%>';" />
        <%}%></td>
      <td ></td>
    </tr>
  </table>
