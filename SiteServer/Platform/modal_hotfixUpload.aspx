...
<form id="MyForm" enctype="multipart/form-data" method="post" runat="server">
  ...
  <div class="tips">在进行补丁修复之前，<font style="color:red">建议手动备份您的数据库和程序文件</font></div>
  <table cellpadding="3" width="95%" align="center">
    <tr>
      <td align="center" valign="top" ><table align="center" width="95%">
          <tr>
            <td align="left"><bairong:help HelpText="选择需要上传的补丁包" Text="补丁包：" runat="server"></bairong:help></td>
