<%@ Page Language="C#" Inherits="SiteServer.Ask.BackgroundPages.BackgroundLinks" %>
...
<user:custom type="showpopwin" runat="server" />
    ...
    <div class="column">
        <div class="columntitle">
            友情链接列表（共<asp:Literal ID="ltlCounts" runat="server"></asp:Literal>项）</div>
        <asp:DataList ID="linksData" ShowHeader="true" CellSpacing="1" CellPadding="1"
            ...
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbg-dark';" style="height: 25px" onmouseout="this.className='tdbg';">
                    ...
                    <td align="center">
                        <asp:Literal ID="ltlLinkName" runat="server"></asp:Literal>
                    </td>
                    <td align="center" >
                        <asp:Literal ID="ltlLinkAddress" runat="server"></asp:Literal>
                    </td>
