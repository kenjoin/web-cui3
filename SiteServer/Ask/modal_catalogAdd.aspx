<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.Ask.BackgroundPages.Modal.CatalogAdd" Trace="false"%>
		  ...
		  <table cellpadding="2" width="95%" align="center">
			...
			<tr>
				<td colspan="2" align="center">
					<asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" style="width:250px;height:230px" TextMode="MultiLine" id="CatalogNames" runat="server"/>
