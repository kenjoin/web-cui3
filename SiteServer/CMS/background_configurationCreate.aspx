...
<form id="myForm" runat="server">
  ...
  <div id="column1" class="column">
    ...
    <table width="95%" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr>
        <td width="245" align="left"><bairong:help HelpText="设置IIS默认页" Text="IIS默认页：" runat="server" ></bairong:help></td>
        <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="30" MaxLength="200" id="IISDefaultPage" runat="server" />
            <asp:RegularExpressionValidator runat="server" ControlToValidate="IISDefaultPage" ValidationExpression="[^']+" ErrorMessage="*" Display="Dynamic" /></td>
      </tr>
      <tr>
