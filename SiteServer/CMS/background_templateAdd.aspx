<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.CMS.BackgroundPages.BackgroundTemplateAdd" %>
    ...
    <table width="100%" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr>
        <td colspan="4" align="center"><div style="border: 1px solid #CCC; width:98%">
            <asp:TextBox width="100%" TextMode="MultiLine" id="Content" runat="server" Height="420" Wrap="false" />
          </div>
