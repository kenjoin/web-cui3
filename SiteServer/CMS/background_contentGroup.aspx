<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundContentGroup" %>
...
<form id="myForm" style="margin:0" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">管理内容组&nbsp;<a href="http://help.siteserver.cn/manage/187/725.html" target="_blank"><img src="../Pic/help_bar.gif" alt="点击查看内容组管理帮助" align="absmiddle"></a></div>
  ...
  <table width="95%" align="center">
    <tr>
      <td align="right"><table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td><asp:Button class="button" id="AddGroup" Text="添加内容组" runat="server" /></td>
          </tr>
        </table></td>
    </tr>
  </table>
