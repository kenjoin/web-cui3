<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundAnalysisUser" enableViewState = "false" %>
...
<form id="myForm" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">用户投稿统计</div>
    <asp:DataList ID="dlUsers" ShowHeader="true" cellspacing="1" cellpadding="1" Width="100%" Align="center" border="0" runat="server">
      <headertemplate>
      ...
      <itemtemplate>
        <tr class="tdbg" onMouseOver="this.className='tdbg-dark';" onMouseOut="this.className='tdbg';" style="height:22px;">
            ...
            <td align="left" style="width:70px;">
              <asp:Literal ID="ltlUserdCount" runat="server"></asp:Literal>
            </td>
            <td align="left" style="width:70px;">
              <asp:Literal ID="ltlPercentage" runat="server"></asp:Literal>
            </td>
          </tr>
      </itemtemplate>
    </asp:DataList>
    <table width="95%" align="center">
      <tr>
        <td align="right"><table cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td><bairong:sqlpager id="spUsers" PagerStyle="NextPrev" PagingMode="NonCached" runat="server" Width="100%" cellspacing=0 border=0></bairong:sqlpager>
              </td>
            </tr>
          </table></td>
      </tr>
