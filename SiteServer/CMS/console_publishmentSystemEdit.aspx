<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.ConsolePublishmentSystemEdit" %>
...
<form id="myForm" runat="server">
  ...
  <DIV class="column">
    ...
    <table width="95%" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr>
        <td width="160" align="left"><bairong:help HelpText="此站点招聘需要的辅助表。" Text="招聘辅助表：" runat="server" ></bairong:help></td>
