<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.BackgroundTableStyleChannel" %>
...
<form id="myForm" Style="margin:0px" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle"><asp:Literal ID="ltlColumnTitle" runat="server"></asp:Literal></div>
    <div class="tips">
