...
<form id="myForm" runat="server">
  ...
  <table cellpadding="2" width="100%" align="center">
    <tr>
      <td align="left" width="140"><bairong:help HelpText="生成页面的路径类型" Text="页面路径类型：" runat="server" ></bairong:help></td>
    ...
    <tr id="RowSubDomainCollection" runat="server">
      ...
      <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" TextMode="MultiLine" Columns="22" Height="100" id="SubDomainCollection" style="ime-mode:disabled;" runat="server" />
