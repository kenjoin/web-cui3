<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.ConsolePublishmentSystemAdd" %>
      ...
      <tr>
        <td colspan="2" height="320" align="left" valign="top"><div style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 30px">
			...
			runat="server"/></td>
                    ...
                    <tr>
                      <td align="left"><bairong:help HelpText="此站点招聘需要的辅助表，必须要选择一个辅助表对招聘进行实际的存取。" Text="招聘辅助表：" runat="server" ></bairong:help></td>
