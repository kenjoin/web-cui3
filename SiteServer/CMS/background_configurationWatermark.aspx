...
<style type="text/css">
	.input-txt { height:18px; border:1px solid; border-color:#adadad #e0e0e0 #e0e0e0 #adadad; font:12px/18px Arial, "宋体"; vertical-align:middle;color:#000;}
</style>
</HEAD>
<body>
  ...
  <DIV class="column">
    ...
    <table width="95%" align="center" cellpadding="3" cellspacing="3">
      ...
      <tr id="WaterMarkImagePathRow" runat="server">
        ...
        <td align="left">
            <asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="55" MaxLength="100" id="WaterMarkImagePath" runat="server"/>
            ...
            &nbsp; <IMG class="preview" src='<%=GetPreviewImageSrc("Image")%>' alt=图片预览 align="absmiddle" name="preview_WaterMarkImagePath" width=88 height=70 id="preview_WaterMarkImagePath">
