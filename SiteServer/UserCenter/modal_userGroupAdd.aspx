...
<form id="myForm" runat="server">
  ...
  <table width="95%" height="20" align="center" cellpadding="4" cellspacing="4">
    ...
    <tr>
      <td width="160" align="left"><bairong:help HelpText="设置用户组的权限级别" Text="权限级别：" runat="server" ></bairong:help></td>
      <td><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" id="Rank" MaxLength="50" Columns="10" runat="server"/>
        <asp:RequiredFieldValidator
			ControlToValidate="Rank"
			ErrorMessage=" *"
			Display="Dynamic"
			runat="server"
			/>
    ...
    <tr>
      <td width="160" align="left"><bairong:help HelpText="设置用户组的详细权限" Text="用户权限：" runat="server" ></bairong:help></td>
      <td><asp:CheckBox ID="IsTouGao" runat="server" Text="允许投稿" Checked="true"></asp:CheckBox>
        <asp:CheckBox ID="IsAttachment" runat="server" Text="允许文件管理" Checked="true"></asp:CheckBox></td>
    </tr>
    <tr>
