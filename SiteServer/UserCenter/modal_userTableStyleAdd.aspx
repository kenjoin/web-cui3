<%@ Page Language="C#" Inherits="UserCenter.BackgroundPages.Modal.UserTableStyleAdd" Trace="false" %>
...
<form id="myForm" runat="server">
  ...
  <table width="95%" align="center" cellpadding="3" cellspacing="3">
    <tr>
      ...
      <td colspan="3" align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="25" MaxLength="50" id="tbAttributeName" runat="server" />
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="tbAttributeName"
						ValidationExpression="[^',\s]+" ErrorMessage="*" Display="Dynamic" /></td>
    </tr>
    <tr>
      <td align="left"><bairong:help HelpText="显示在表单界面中的名称" Text="显示名称：" runat="server" ></bairong:help></td>
      <td colspan="3" align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="25" MaxLength="50" id="DisplayName" runat="server" />
        <asp:RequiredFieldValidator ControlToValidate="DisplayName" ErrorMessage="*" Display="Dynamic" runat="server" />
    ...
    <tr>
      ...
      <td colspan="3" align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="60" id="HelpText" runat="server" />
