<%@ Page Language="C#" Inherits="UserCenter.BackgroundPages.BackgroundUser" %>
...
<form id="myForm" Style="margin:0px" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">用户搜索&nbsp;<a href="http://help.siteserver.cn/manage/219/800.html" target="_blank"><img src="../Pic/help_bar.gif" alt="点击查看用户管理帮助" align="absmiddle"></a></div>
    <TABLE width="100%" border=0 align=center cellPadding=2 cellSpacing=2>
      <TBODY>
        <TR class=summary-title align=left>
          <TD align=left style="padding-left:10px; line-height:26px;"> 每页显示条数：
