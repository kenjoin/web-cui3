<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.Modal.FilePathRule" Trace="false"%>
...
<form id="myForm" runat="server">
  ...
  <table cellpadding="3" width="95%" align="center">
    <tr>
      <td colspan="2" align="left"><div class="columnsubtitle">替换内容</div>
    ...
    <tr>
      <td width="150" align="center"><bairong:help HelpText="系统生成文件时采取的文件名规则" Text="页面命名规则：" runat="server" ></bairong:help></td>
      <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="50" id="TheRule" runat="server" /></td>
    </tr>
    <tr>
