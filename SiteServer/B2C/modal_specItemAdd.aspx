...
<form id="myForm" runat="server">
  ...
  <table width="95%" align="center" cellpadding="2" cellspacing="2">
    <tr>
      <td width="120" align="left"><bairong:help HelpText="规格值名称" Text="规格值名称：" runat="server" ></bairong:help></td>
      <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="25" MaxLength="50" id="tbTitle" runat="server" />
        <asp:RequiredFieldValidator ControlToValidate="tbTitle" ErrorMessage="*" Display="Dynamic" runat="server" />
        <asp:RegularExpressionValidator runat="server" ControlToValidate="tbTitle" ValidationExpression="[^',]+" ErrorMessage="*" Display="Dynamic" /></td>
    </tr>
    <asp:PlaceHolder ID="phIcon" runat="server">
    <tr>
      <td width="120" align="left"><bairong:help HelpText="图标" Text="图标：" runat="server" ></bairong:help></td>
