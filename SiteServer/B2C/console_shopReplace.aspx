<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.ConsoleShopReplace" %>
...
AutoGenerateColumns="false"
            ...
            <asp:panel id="CreateSiteParameters" runat="server" Visible="false">
              <DIV class="tips"> 您选择的商城模板为：
                <asp:Label ID="SiteTemplateName" runat="server"></asp:Label>
                ，请设置导入选项： </DIV>
              <DIV style="PADDING-LEFT: 10px; PADDING-TOP: 10px">
                <table width="95%" align="center" cellpadding="3" cellspacing="3">
                  <tr>
                    <td width="160" align="left"><bairong:help HelpText="清除商城栏目及内容" Text="清除商城栏目及内容：" runat="server" ></bairong:help></td>
                    <td align="left"><asp:RadioButtonList ID="IsDeleteChannels" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="清除商城栏目及内容" Value="True"></asp:ListItem>
                        <asp:ListItem Text="保留商城栏目及内容" Value="False" Selected="true"></asp:ListItem>
                      </asp:RadioButtonList></td>
                  </tr>
                  <tr>
                    <td width="160" align="left"><bairong:help HelpText="清除商城显示模板" Text="清除商城显示模板：" runat="server" ></bairong:help></td>
                    <td align="left"><asp:RadioButtonList ID="IsDeleteTemplates" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="清除商城显示模板" Value="True"></asp:ListItem>
                        <asp:ListItem Text="保留商城显示模板" Value="False" Selected="true"></asp:ListItem>
                      </asp:RadioButtonList></td>
                  </tr>
                  <tr>
                    <td width="160" align="left"><bairong:help HelpText="清除商城文件" Text="清除商城文件：" runat="server" ></bairong:help></td>
                    <td align="left"><asp:RadioButtonList ID="IsDeleteFiles" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="清除商城文件" Value="True"></asp:ListItem>
                        <asp:ListItem Text="保留商城文件" Value="False" Selected="true"></asp:ListItem>
                      </asp:RadioButtonList></td>
                  </tr>
                  <tr>
