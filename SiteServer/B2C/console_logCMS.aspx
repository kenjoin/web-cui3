<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.ConsoleLogCMS" %>
...
<form id="myForm" style="margin:0" runat="server">
      ...
      <TBODY>
        <TR align=left>
          <TD align=left style="padding-left:10px; line-height:35px;"> 站点：
            ...
            类型：
            <asp:DropDownList ID="LogType" AutoPostBack="true" OnSelectedIndexChanged="Search_OnClick" runat="server"></asp:DropDownList></TD>
        </TR>
        <TR align=left>
  ...
  <DIV id="contents" class="column">
    <div class="columntitle">站点管理日志</div>
