<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundContentPhotoUpload" %>
...
$(document).ready(function(){
	swfu = new SWFUpload({
		// Backend Settings
		upload_url: "background_ajaxUpload.aspx?PublishmentSystemID=<%=PublishmentSystemID%>&isContentPhotoSwfUpload=True",
...
<TABLE cellSpacing="3" style="border-bottom:#c5daf0 1px dashed" cellpadding="3">
    ...
    <TD valign="top"><TABLE cellPadding=5>
            <TR>
              <TD>图片说明:</TD>
              <TD><textarea id="Description_0" name="Description_0" rows="4" class="colorblur" onFocus="this.className='colorfocus';" onBlur="this.className='colorblur';" style="WIDTH: 350px"></textarea></TD>
            </TR>
        </TABLE></TD>
...
<script type="text/javascript">
var ajaxUploadUrl = 'background_ajaxUpload.aspx?publishmentSystemID=<%=PublishmentSystemID%>&isContentPhoto=True';
