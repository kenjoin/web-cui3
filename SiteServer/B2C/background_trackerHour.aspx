<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundTrackerHour" %>
...
<form id="myForm" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">访问量24小时分配图表</div>
  ...
  <div class="column">
    <div class="columntitle">访客24小时分配图表</div>
    <TABLE cellPadding=2 border=0>
      <TBODY>
        <TR>
          <TD>单位（人）</TD>
