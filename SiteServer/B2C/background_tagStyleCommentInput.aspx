<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundTagStyleCommentInput" %>
...
<form id="myForm" style="margin:0" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">评论提交样式</div>
    <ASP:DataGrid id="MyDataGrid" runat="server"
      ...
      <asp:TemplateColumn>
        <ItemTemplate> <a href="background_tagStyleCommentInput.aspx?Delete=True&PublishmentSystemID=<%=Request.QueryString["PublishmentSystemID"]%>&StyleID=<%# DataBinder.Eval(Container.DataItem,"StyleID")%>" onClick="javascript:return confirm('此操作将删除评论提交样式“<%# DataBinder.Eval(Container.DataItem,"StyleName")%>”，确认吗？');">删除</a> </ItemTemplate>
        <ItemStyle Width="50" HorizontalAlign="center" />
      </asp:TemplateColumn>
      </Columns>
    </ASP:DataGrid>
  ...
  <table width="95%" align="center">
    ...
    <tr>
      <td><div class="tips">小提示：评论提交标签为&lt;stl:commentInput styleName=&quot;样式名称&quot;&gt;&lt;/stl:commentInput&gt;，用于实现评论功能。<a href="http://help.siteserver.cn/stl/commentInput.html" target="_blank">查看标签帮助</a></div></td>
    </tr>
  </table>
</form>
</body>
