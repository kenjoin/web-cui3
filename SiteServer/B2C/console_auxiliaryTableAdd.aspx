<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.ConsoleAuxiliaryTableAdd" %>
  ...
  <DIV class="column">
    ...
    <table width="95%" align="center" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="35" MaxLength="50" id="TableENName" runat="server" />
