<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundTrackerDay" %>
...
<form id="myForm" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">访问量最近30日分配图表</div>
          ...
          <TD align=middle><TABLE align=center>
              <TBODY>
                <TR vAlign=bottom>
                  ...
                  <TD noWrap align=middle width=16 
  ...
  <div class="column">
    <div class="columntitle">访客最近30日分配图表</div>
    <TABLE cellPadding=2 border=0>
      <TBODY>
        <TR>
          <TD>单位（人）</TD>
