<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundMailSubscribe" %>
...
<form id="myForm" style="margin:0" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">邮件订阅查询</div>
  ...
  <DIV id="contents" class="column">
    <div class="columntitle">邮件订阅列表</div>
    <asp:DataList ID="MyDataList" ShowHeader="true" cellspacing="1" cellpadding="1" Align="center" border="0" Width="100%" runat="server" style="word-break: break-all">
      <headertemplate>
        <tr class="summary-title" style="height:25px;">
          <td align="Center" style="width:160px;" width="160">&nbsp;订阅人</td>
      ...
      <itemtemplate>
        <tr class="tdbg" onMouseOver="this.className='tdbg-dark';" onMouseOut="this.className='tdbg';" style="height:25px;">
          <td align="left" style="width:160px;" width="160"><asp:Literal ID="ltlReceiver" runat="server"></asp:Literal></td>
          <td align="left"><asp:Literal ID="ltlMail" runat="server"></asp:Literal></td>
  ...
  <table width="95%" align="center">
    <tr>
      <td align="right"><table cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td><asp:Button class="button" id="AddButton" Text="添加订阅" runat="server" />
              &nbsp;&nbsp;
              <asp:Button class="button" id="Export" Text="导出Excel" runat="server" />
              &nbsp;&nbsp;
