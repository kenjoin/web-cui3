<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundTrackerMonth" %>
...
<form id="myForm" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">访问量最近12月分配图表</div>
  ...
  <div class="column">
    <div class="columntitle">访客最近12月分配图表</div>
    <TABLE cellPadding=2 border=0>
      <TBODY>
        <TR>
          <TD>单位（人）</TD>
