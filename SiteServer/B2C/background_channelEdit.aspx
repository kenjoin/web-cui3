<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.B2C.BackgroundPages.BackgroundChannelEdit" %>
...
function changeContentModelID()
{
	var val = $('#ContentModelID').val();
	if (val != 'Goods'){
		$('#trIsPhysical').hide();
		$('#trIsBrandSpecified').hide();
		$('#trBrandIDCollection').hide();
	}else{
		$('#trIsBrandSpecified').show();
		if ($("input[name='IsBrandSpecified'][checked]").val() == 'True'){
			$('#trBrandIDCollection').show();
		}else{
			$('#trBrandIDCollection').hide();	
		}
	}	
...
$(document).ready(function() {
	...
	$('#ContentModelID').change(changeContentModelID);
	$('#IsBrandSpecified').click(changeContentModelID);
	changeContentModelID();
});
</script>
...
<form id="myForm" runat="server">
  ...
  <div id="column1" class="column">
    <table width="98%" align="center" cellpadding="3" cellspacing="3">
      <tr>
        <td width="150" align="left"><bairong:help HelpText="栏目的名称" Text="栏目名称：" runat="server" ></bairong:help></td>
      ...
      <tr>
        <td align="left"><bairong:help HelpText="设置栏目的内容模型" Text="内容模型：" runat="server" ></bairong:help></td>
        <td align="left"><asp:DropDownList id="ContentModelID" runat="server"> </asp:DropDownList></td>
      </tr>
      <tr id="trIsPhysical">
        <td align="left"><bairong:help HelpText="是否实体商品" Text="是否实体商品：" runat="server" ></bairong:help></td>
        <td align="left"><asp:RadioButtonList id="IsPhysical"
      ...
      <tr id="trIsBrandSpecified">
        <td align="left"><bairong:help HelpText="是否关联品牌栏目" Text="是否关联品牌栏目：" runat="server" ></bairong:help></td>
        <td align="left"><asp:RadioButtonList id="IsBrandSpecified"
			RepeatDirection="Horizontal" RepeatLayout="Flow"
			runat="server">
            <asp:ListItem Text="是" Value="True" />
            <asp:ListItem Text="否" Value="False" Selected="True"/>
          </asp:RadioButtonList>&nbsp;<span class="gray">如果不关联品牌，商品将从全部品牌中选择</span></td>
      </tr>
      <tr id="trBrandIDCollection">
        <td align="left"><bairong:help HelpText="本栏目下商品的关联品牌" Text="关联品牌：" runat="server" ></bairong:help></td>
        <td align="left"><asp:DropDownList ID="BrandNodeID" runat="server"></asp:DropDownList>
        <asp:RequiredFieldValidator 
			ControlToValidate="BrandNodeID"
			ErrorMessage="必须选择品牌栏目"
			Display="Dynamic"
			runat="server"/></td>
      </tr>
      ...
      <tr>
        ...
        <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="38" MaxLength="200" id="ChannelFilePathRule" runat="server"/>
          <asp:HyperLink ID="CreateChannelRule" NavigateUrl="javascript:undefined;" runat="server">构造</asp:HyperLink></td>
      </tr>
      <tr>
        ...
        <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" Columns="38" MaxLength="200" id="ContentFilePathRule" runat="server"/>
          <asp:HyperLink ID="CreateContentRule" NavigateUrl="javascript:undefined;" runat="server">构造</asp:HyperLink></td>
      </tr>
      <tr>
        ...
        <td align="left"><asp:TextBox class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" ID="NavigationPicPath"
				...
				runat="server"/>
          <nobr>
          <asp:HyperLink ID="SelectImage" NavigateUrl="javascript:undefined;" runat="server">选择</asp:HyperLink>
          <asp:HyperLink ID="UploadImage" NavigateUrl="javascript:undefined;" runat="server">上传</asp:HyperLink>
          <a id="preview_NavigationPicPath" name="preview_NavigationPicPath" href="<%=PreviewImageSrc%>">预览</a> 
          </nobr></td>
      </tr>
      <tr align="left">
        <td colspan="2"><site:TextEditorControl id="Content" runat="server"></site:TextEditorControl></td>
      </tr>
      <tr>
        <td align="left"><bairong:help HelpText="为搜索引擎提供的关键字列表" Text="关键字列表：" runat="server" ></bairong:help></td>
      ...
      <tr>
        <td align="left"><bairong:help HelpText="用来告诉搜索引擎网页的主要内容。" Text="页面描述：" runat="server" ></bairong:help></td>
  ...
  <div id="column2" style="display:none" class="column">
    <table width="98%" align="center" cellpadding="3" cellspacing="3">
      <tr id="LinkURLRow" runat="server">
        <td width="150" align="left"><bairong:help HelpText="当链接类型为与栏目及内容无关时便链接到此地址" Text="外部链接：" runat="server" ></bairong:help></td>
      ...
      <tr id="LinkTypeRow" runat="server">
        <td align="left"><bairong:help HelpText="指示此栏目的链接与栏目下子栏目及内容的关系" Text="链接类型：" runat="server" ></bairong:help></td>
        <td colspan="2" align="left"><asp:DropDownList id="LinkType" runat="server"> </asp:DropDownList></td>
      </tr>
      <tr id="ChannelTemplateIDRow" runat="server">
        <td align="left"><bairong:help HelpText="此栏目所用到的模版" Text="栏目模版：" runat="server" ></bairong:help></td>
        <td colspan="2" align="left"><asp:DropDownList id="ChannelTemplateID" DataTextField="TemplateName" DataValueField="TemplateID" runat="server"> </asp:DropDownList></td>
      </tr>
      <tr>
        <td align="left"><bairong:help HelpText="此栏目内的内容所用到的内容模版" Text="本栏目的内容模版：" runat="server" ></bairong:help></td>
        <td colspan="2" align="left"><asp:DropDownList id="ContentTemplateID" DataTextField="TemplateName" DataValueField="TemplateID" runat="server"> </asp:DropDownList></td>
      </tr>
      <tr>
        <td align="left"><bairong:help HelpText="是否可以添加子栏目" Text="可以添加栏目：" runat="server" ></bairong:help></td>
        <td align="left" style="width:120px;"><asp:RadioButtonList id="IsChannelAddable"
      ...
      <tr>
        <td align="left"><bairong:help HelpText="指此栏目是否能够添加内容" Text="可以添加内容：" runat="server" ></bairong:help></td>
