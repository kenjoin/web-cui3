<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.BackgroundContentTrash" %>
...
<form id="myForm" style="margin:0" runat="server">
  ...
  <DIV class="column">
    <div class="columntitle">内容回收站管理&nbsp;<a href="http://help.siteserver.cn/manage/192/741.html" target="_blank"><img src="../Pic/help_bar.gif" alt="点击查看内容回收站帮助" align="absmiddle"></a></div>
  ...
  <DIV class="column" id="contents">
    <div class="columntitle">内容回收站列表</div>
    <asp:DataList ID="MyDataList" ShowHeader="true" cellspacing="1" cellpadding="1" Align="center" border="0" Width="100%" runat="server">
      <headertemplate>
        <tr class="summary-title" style="height:25px;">
          ...
          <td align="Center" style="width:120px;">删除日期</td>
      ...
      <itemtemplate>
        <tr class="tdbg" style="height:25px;">
          ...
          <td align="Center" style="width:120px;"><asp:Literal ID="ItemDeleteDate" runat="server"></asp:Literal></td>
  ...
  <table width="95%" align="center">
    <tr>
      <td align="right"><table cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td><asp:Button class="button" id="SelectButton" Text="选择显示项" runat="server" />
              &nbsp;
              <asp:Button class="button" id="Restore" Text="还 原" runat="server" />
              &nbsp;
              <asp:Button class="button" id="RestoreAll" Text="全部还原" runat="server" />
              &nbsp;
              <asp:Button class="button" id="Delete" Text="删 除" runat="server" />
              &nbsp;
              <asp:Button class="button" id="DeleteAll" Text="清空回收站" runat="server" /></td>
          </tr>
        </table></td>
    </tr>
  </table>
