<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.Modal.AddToGroup" Trace="false"%>
...
<form id="myForm" runat="server">
  ...
  <table cellpadding="2" width="95%" align="center">
    <tr>
      <td align="left"><bairong:help HelpText="组名称" Text='组名称：<input type="checkbox" id="check_groups" onClick=checkAll(document.getElementById("Group"),this.checked);><label for="check_groups">全选</label>'  runat="server" ></bairong:help>
        <span id="Group">
