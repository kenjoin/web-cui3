<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.Modal.PermissionsSet" Trace="false"%>
...
<form id="myForm" runat="server">
  ...
  <table cellpadding="3" width="95%" align="center">
    ...
    <tr id="SitesRow" runat="server">
      <td width="140" align="left"><bairong:help HelpText="选择此管理员唯一可以管理的站点" Text="唯一可以管理的站点：" runat="server" ></bairong:help></td>
      <td  align="left"><asp:DropDownList ID="PublishmentSystemIDDropDownList" runat="server"></asp:DropDownList></td>
    </tr>
