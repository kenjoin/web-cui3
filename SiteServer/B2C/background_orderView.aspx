...
<body>
    ...
    <asp:Button ID="Pay" class="button" runat="server" Text="支付" style="MARGIN-BOTTOM: 0px" />
    <asp:Button ID="Consignment" class="button" runat="server" Text="发货" style="MARGIN-BOTTOM: 0px"/>
    <asp:Button ID="Success" class="button" runat="server" Text="完成"  style="MARGIN-BOTTOM: 0px"/>
    <asp:Button ID="Refund" class="button" runat="server" Text="退款" style="MARGIN-BOTTOM: 0px" />
    <asp:Button ID="Return" class="button" runat="server" Text="退货" style="MARGIN-BOTTOM: 0px" />
    <asp:Button ID="Fail" class="button" runat="server" Text="作废" style="MARGIN-BOTTOM: 0px" />
    </div>
    <div class="baseinfo">
