<%@ Page Language="C#" Inherits="SiteServer.B2C.BackgroundPages.Modal.TableMetadataAdd" %>
...
<form id="MyForm" runat="server">
  ...
  <table width="95%" align="center" cellpadding="3" cellspacing="3">
    ...
    <tr>
      <td align="left"><bairong:help HelpText="需要添加的字段名称" Text="字段名：" runat="server" ></bairong:help></td>
    ...
    <tr>
      <td align="left"><bairong:help HelpText="此字段的数据类型" Text="数据类型：" runat="server" ></bairong:help></td>
      <td align="left"><asp:DropDownList ID="DataType" runat="server" onChange="updateTextData();"> </asp:DropDownList></td>
    </tr>
    <tr>
      <td align="left"><bairong:help HelpText="此字段的数据长度" Text="数据长度：" runat="server" ></bairong:help></td>
    ...
    <tr>
      <td align="left"><bairong:help HelpText="此字段是否允许为空，如果不允许为空，建议添加数据库默认值。" Text="是否允许为空：" runat="server" ></bairong:help></td>
    ...
    <tr>
      <td align="left"><bairong:help HelpText="此字段的默认值" Text="数据库默认值：" runat="server" ></bairong:help></td>
