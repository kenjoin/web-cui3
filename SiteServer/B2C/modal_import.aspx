<%@ Page Language="C#" Trace="false" Inherits="SiteServer.B2C.BackgroundPages.Modal.Import" %>
...
<html>
<head>
<title><asp:Literal id="TheTitle" runat="server" /></title>
  ...
  <table cellpadding="3" width="95%" align="center">
    <tr>
      <td align="center" valign="top" ><table align="center" width="95%">
          <tr>
            <td align="left"><bairong:help HelpText="选择需要导入的文件" Text="需要导入的文件：" runat="server"></bairong:help>
            </td>
		  ...
		  <tr>
            <td align="left"><bairong:help HelpText="遇到同名规则是否覆盖" Text="是否覆盖同名规则：" runat="server" ></bairong:help>
            </td>
            <td align="left">
