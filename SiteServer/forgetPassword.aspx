...
<title><%=GetProductName()%> 找回密码</title>
...
#Login .login_bg {height:260px;background:#F9F9F9;border-right:1px solid #8A8A8A;border-left:1px solid #8A8A8A;}
...
#Login .txt3 {text-align:left;margin:10px 0 0 22px;}
...
<body onload="document.getElementById('form1').focus()">
<div id="Logo">
		...
		<div class="login_bg">
			...
			<asp:PlaceHolder ID="phUserNameTemplate" runat="server">
				<div class="input_id">用户名：
					<asp:TextBox id="UserName" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" type="text" runat="server"></asp:TextBox>
					<asp:RequiredFieldValidator ControlToValidate="UserName" ErrorMessage=" *"  Display="Static" runat="server" />
				</div>
				<div class="input_post"><asp:Button class="button" CommandName="userName" oncommand="Button_Command" text="下一步" runat="server"/>
				</div>			
			</asp:PlaceHolder>
            <asp:PlaceHolder ID="phQuestionTemplate" runat="server">
			  <div class="input_id">请回答问题：
				...
				<div class="input_id">答案：
					<asp:TextBox id="Answer" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';" type="text" runat="server"></asp:TextBox>
					<asp:RequiredFieldValidator ControlToValidate="Answer" ErrorMessage=" *"  Display="Static" runat="server" />
				</div>
			  <div class="input_post"><asp:Button class="button" CommandName="question" oncommand="Button_Command" text="下一步" runat="server"/>
				</div>
              </asp:PlaceHolder>
		  ...
		  <div class="txt3">
				当前版本：<asp:Literal ID="Version" runat="server"></asp:Literal><br />
				.NET 版本：<%=System.Environment.Version.ToString()%><br />
